...
def generate_launch_description():
    ...
    # World path - track_02 (obstacle track)
    world_path = os.path.join(pkg_auto_simulation, 'worlds', 'track_02.world')
    ...
    # Spawn Entity - Right lane center (Y = -0.2 for 0.4m lane width)
    spawn_entity = Node(
        package='gazebo_ros',
